...
$(document).ready(function () {
  ...
  let topLineImgSrc = 'img/logo-top.svg';
  ...
  $(".main").onepage_scroll({
    ...
    beforeMove: function (index) {
      setPrevSection(index);
      setActivePagination();
      index < 3 ? startAnimationLogo() : null;
    }
  });

  const activeSlide = $('.onepage-pagination li a.active');
  activeSlide.parent().addClass('active');
  ...
  $(".site-switch__option_dark-theme").on("click", function () {
    $('body').addClass('dark-theme');
    $(".site-switch__option_ligt-theme").removeClass('site-switch__option_active');
    $(this).addClass('site-switch__option_active');
    $('.content-background').css("background-image", "url('../img/background-site-dark.png'");
    $('.content-title img').attr("src", "../img/text_up_black.svg");
    $('.content-subtitle img').attr("src", "../img/text_down_black.svg");
    $('.top-line-logo').attr("src", "../img/top-line-logo-dark.svg");

    topLineImgSrc = 'img/top-line-logo-dark.svg';
  });

  $(".site-switch__option_ligt-theme").on("click", function () {
    $('body').removeClass('dark-theme');
    $(".site-switch__option_dark-theme").removeClass('site-switch__option_active');
    $(this).addClass('site-switch__option_active');
    $('.content-background').css("background-image", "url('../img/background-site.png'");
    $('.content-title img').attr("src", "../img/cit_up.svg");
    $('.content-subtitle img').attr("src", "../img/cit_down.svg");
    $('.top-line-logo').attr("src", "../img/logo-top.svg");

    topLineImgSrc = 'img/logo-top.svg';
  });

  function setPrevSection(currentActiveSection) {
    moveCounter += 1;
    if (moveCounter % 2 === 0) {
      prevActive = currentActive;
      currentActive = currentActiveSection;
    }
    moveCounter === 10000 ? moveCounter = 1 : null;
  }

  $(".button_go-back").on("click", function () {
    $(".main").moveTo(prevActive);
  });

  function startAnimationLogo() {
    for (let flipCounter = 1; flipCounter < 3; flipCounter++) {
      setTimeout(function flip() {
        $('.top-line-logo').addClass('start-animation-flip');

        setTimeout(function backFlip() {
          $('.top-line-logo').removeClass('start-animation-flip');
        }, flipCounter * 250);
      }, flipCounter * 250);
    }
  }
  ...
  $('.burger-wrapper').on("click", function () {
    ...
    $('.menu-background').toggleClass('menu-background_active');
    $('.content-background').toggleClass('blur');
    $('.onepage-pagination').toggleClass('menu-open');

    if (windowSize.matches && $('.onepage-pagination').hasClass('menu-open')) {
      $('.top-line-logo').attr("src", "img/top-line-logo-dark.svg");
    } else {
      $('.top-line-logo').attr("src", topLineImgSrc);
    }
  })
  ...
  $('.button_order').on("click", function () {
    ...
    if(orderForm.hasClass('order-form_visible')) {
      $('.order-form').submit();
    }

    orderForm.toggleClass('order-form_visible');
    $('.content-right-text__description').toggleClass('content-right-text__description_hide');
  });
});